...
import static com.objectfrontier.training.java.webservices.statements.AddressStatements.CREATE_QUERY;
import static com.objectfrontier.training.java.webservices.statements.AddressStatements.DELETE_QUERY;
import static com.objectfrontier.training.java.webservices.statements.AddressStatements.READ_ALL_QUERY;
import static com.objectfrontier.training.java.webservices.statements.AddressStatements.READ_QUERY;
import static com.objectfrontier.training.java.webservices.statements.AddressStatements.UPDATE_QUERY;
...
public class AddressService {
    ...
    public boolean validateAddress(Connection connection, Address address) {
        ...
        if (connection != null) {
            ...
            if (((address.getStreet()).equals(null)) || (address.getStreet().trim().length() <= 0)) {
                exceptionList.add(ExceptionCodes.STREET_NAME_EMPTY);
            }
            if (((address.getCity()).equals(null)) || (address.getCity().trim().length() <= 0)) {
                exceptionList.add(ExceptionCodes.CITY_NAME_EMPTY);
            }
            if ((address.getPostalCode() <= 0)) {
                exceptionList.add(ExceptionCodes.POSTAL_CODE_EMPTY);
            }
